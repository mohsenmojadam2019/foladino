...
<header class="topbar">
    <div class="container nav-wrap">
        <a class="brand" href="{{ route('home') }}"><img src="/images/logo-mark.svg" alt="فولادینو"><span><strong>فولادینو</strong><small>بازار هوشمند آهن‌آلات</small></span></a>
        ...
        <div class="nav-actions">
            <div class="search-mini"><svg viewBox="0 0 24 24"><path d="m21 21-4.3-4.3m2.3-5.2A7.5 7.5 0 1 1 4 11.5a7.5 7.5 0 0 1 15 0Z"/></svg><input placeholder="جستجوی محصول، کارخانه یا استاندارد ..."></div>
...
<footer id="footer" class="footer">
  <div class="container footer-grid">
    <div><a class="brand footer-brand" href="/"><img src="/images/logo-mark.svg"><span><strong>فولادینو</strong><small>بازار هوشمند آهن‌آلات</small></span></a><p>تأمین شفاف، سریع و قابل پیگیری برای پروژه‌های ساختمانی و صنعتی سراسر ایران.</p></div>
  ...
  <div class="container footer-bottom"><span>تمامی حقوق برای فولادینو محفوظ است. {{ fa_digits('1405') }} ©</span><span>قیمت شفاف · تأمین مطمئن · تحویل سراسر کشور</span></div>
</footer>
